...
function main() {
  ...
  const staticPages = [
    ...
    {
      path: "tools/cheongyak/index.html",
      title: `신혼부부 특별공급 가점 계산기 | ${SITE_NAME}`,
      desc: `「주택공급에 관한 규칙」 별표1 기준으로 신혼부부 특별공급 가점과 일반 청약가점제 점수를 동시에 계산해 드립니다. 자녀·혼인 기간·청약통장·신생아 가산까지 단계별 확인.`,
      url: `${SITE_URL}/tools/cheongyak`,
      body: buildStaticPageBody(
        "신혼부부 특별공급 가점 계산기",
        `<p>「주택공급에 관한 규칙」 별표1 가점 산정 기준과 신혼부부 특별공급 운영지침에 따른 표준 가점 체계를 토대로, 본인 가구의 자녀 수·혼인 기간·청약통장 납입 회차·무주택 기간·해당 지역 거주·신생아 가구 여부·다자녀 가산 등을 입력하시면 신혼특공 예상 가점과 일반 청약가점제 84점 만점 점수를 동시에 산출해 드립니다. 2024년 개정으로 도입된 배우자 청약통장 50% 합산 규정도 반영했습니다. 출처: 청약홈, 법제처 주택공급에 관한 규칙, 국토교통부.</p>`
      ),
    },
  ];
