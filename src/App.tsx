        ...
        <AnimatePresence mode="wait">
          ...
          {currentPage === "about" && (
            ...
            >
              ...
              <h2>편집 검증 프로세스</h2>
              <p>모든 게시물은 세 단계 검토를 거쳐 발행됩니다. 1차 자료 수집과 본문 구성, 수치와 법령 조문의 팩트 체크, 표현의 정확성과 면책 고지의 적절성 검토. 정책이 변경되면 본문을 수정하고 글 하단 갱신 일자를 갱신합니다. 부정확한 부분을 발견하시면 <a href="mailto:apark12321@gmail.com">apark12321@gmail.com</a>으로 알려 주시면 영��일 3일 이내 검토 후 반영합니다.</p>
          ...
          {currentPage === "privacy" && (
            ...
            >
              ...
              <ul>
                <li><strong>부서명:</strong> 상상아트 고객 ���대팀</li>
          ...
          {currentPage === "terms" && (
            ...
            >
              ...
              <p className="text-[16px] leading-[1.8] text-[#3F3D56] mb-10 break-keep">
                ��� 약관은 홈코노미뉴스(이하 "사이트")가 제공하는 콘텐츠 및 부가 서비스(이하 "서비스")의 이용과 관련하여 사이트와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
              </p>
              ...
              <h2>제6조 (콘텐츠의 저작권)</h2>
              <p>사이트가 작성한 모든 콘텐츠의 저작권은 운영자인 상상아트에 귀속됩니다. 이용자는 ��영자의 사전 서면 동의 없이 콘텐츠를 영리 목적으로 이용하거나 제3자에게 이용하게 할 수 없습니다. 단, 출처를 명시한 비영리적·개인적 인용은 허용됩니다.</p>
